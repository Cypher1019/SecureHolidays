...
const seedHotels = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const hotelsWithUsers = hotels.map((hotel, index) => (Object.assign(Object.assign({}, hotel), { userId: users[index % users.length]._id.toString(), lastUpdated: new Date() })));
        const createdHotels = yield hotel_1.default.insertMany(hotelsWithUsers);
